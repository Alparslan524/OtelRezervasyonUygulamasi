...
{
    public class StandartRez : IRezAl
    {
        ...
        public void RezAl(Musteri m)
        {
            ...
            try
            {
                ...
                komut.CommandText = ("declare @sayac int " +
                                     ...
                                     "begin " +
                                         ...
                                         "if(@Dolumu='0') " +
                                         "begin " +
                                             "update Tbl_Oda set OdenecekTutar=@pFiyat, RezNo=3,RezTarih=GETDATE(),GirisTarihi = @pGirisTarihi,CikisTarihi = @pCikisTarihi,MusteriID = @pMusteriID ,DoluMu='1' where ODAID = @sayac " +
                                             "break " +
                                         "end " +
                ...
                m.UcretCekme(m);
                m.OdenecekTutar = (m.OdenecekTutar )*(fark.Days);
            ...
            MessageBox.Show("Rezervasyon türünüz Standarttır." + "\n" + "Ödenecek Tutar: " + m.OdenecekTutar + "\n" + m.CikisTarih+" tarihinde ödemeyi yapınız ");
